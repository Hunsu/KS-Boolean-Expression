...
public class NumericFunctionPanel extends JDialog {
	...
	/**
	 * Cr�e et aafiche la boite de dialogue
	 */
	public NumericFunctionPanel(final Controller controller) {
		...
		nbrVarComboBox.setModel(new DefaultComboBoxModel<Integer>(new Integer[] {1, 2, 3, 4, 5, 6, 7, 8}));
	...
	/**
	 * Retourne les lignes de la tables de v�rit�<br>
	 * o� la fonction et � 0.
	 */
