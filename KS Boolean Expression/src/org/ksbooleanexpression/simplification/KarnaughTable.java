...
public class KarnaughTable {
    ...
    {
    	// PREMIER CAS: le nombre de variables est �gal � 1
  	  if(nbVar==1)
  	  {
  	  ...
  	  // DEUXIEME CAS: le nombre de variables est �gal � 2
  	  if(nbVar==2)
  	  {
  		  kmap[0][0].cellAdress=0;
  		  kmap[0][1].cellAdress=1;
  ...
  //CINQIEME CAS: le nombre de variables est 7 ou 8
     ...
     * @param m num�ro de la celule d�termin� par j%4+((i%4)*4)<br>
