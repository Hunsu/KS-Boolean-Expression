...
public class ControllerAction extends ResourceAction {
	 ...
	 * 
	 * @param preferences
	 *            preferences les pr�f�rences de l'utilisateur pour savoir en
	 *            quelle langue lire les prori�t�s
	 * @param actionPrefix
	 *            pr�fix utilis� pour retrouver les propri�t�s de l'action
	 * @param controller
	 *            le controlleur dans lequel se trouve la m�thode � appeller
	 * @param method
	 *            le nom de la m�thode � appeller et qui se trouve dans le
	 *            controlleur
	 * @param parameters
	 *            la liste des param�tres de <code>method</code>
	 * @throws NoSuchMethodException
	 *             si <code>method</code> avec les param�tres
	 *             <code>parameters</code> n'existe pas
	 */
	public ControllerAction(UserPreferences preferences,
			Class<?> resourceClass, String actionPrefix, Object controller,
	 ...
	 *             <code>parameters</code> n'existe pas
	 */
	public ControllerAction(UserPreferences preferences, String actionPrefix,
			boolean enabled, Object controller, String method,
